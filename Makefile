...
build-wasm-web-dev-watch:
	cd vault-wasm && cargo watch -w . -i .gitignore -w ../vault-core -w ../vault-web-api -i ../vault-core/.gitignore -s "wasm-pack build --target web --out-dir ../vault-web/src/vault-wasm --out-name vault-wasm --dev"
...
intl-web-extract:
	vault-web/scripts/intl-extract.sh
