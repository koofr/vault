...
use super::constants::{BLOCK_DATA_SIZE, FILE_MAGIC, FILE_MAGIC_SIZE, FILE_NONCE_SIZE};
use super::data_cipher::encrypt_block;
...
mod tests {
    ...
    use crate::cipher::data_cipher::{decrypt_block, get_data_cipher};
